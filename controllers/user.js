...
module.exports.superUser = async function(req,res){
  try {
    ...
    await User.create({
      ...
      email:"aakash@aakash",
      password:"aakash",
      confirmPassword:"aakash",
      department:"HR"
    })
    return res.end(`<h3>user credentials</h3> <p>email:  aakash@aakash <br> paasword :  aakash</p> <h2>please delete aakash as soon as you create new user</h2> </h2> `)
  } catch (error) {
    console.log(error);
